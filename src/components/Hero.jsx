    ...
    <div className="mt-[50px] md:mt-20 text-center">
     <div className="relative max-w-max mx-auto pt-8 pl-8">
      <motion.span variants={variants.fadeInUp} className="absolute top-0 left-0">
       <img src="assets/images/shape-1.png" alt="Title Shape" width={39} height={43} />
      </motion.span>

      <motion.div
      variants={variants.fadeInUp}
      className="flex items-center bg-white-99 border border-white-95 rounded-lg p-3.5 justify-centergap-2.5 max-w-max mx-auto flex-wrap text-center">
       <span>
        <img src="assets/images/shape-2.png" alt="Title Shape" width={48} height={48} />
       </span>
     ...
     className="text-2xl font-medium mt-4 md:text-[28p]">with Online Design and Development Courses.</motion.p>
      ...
      <Marquee pauseOnHover={true}>
       {heroLogos.map((logo) => (
        <div className="px-14 py-5" key={logo.id}>
         <img src={`assets/${logo.item}`} alt="logo" width={logo.width} height={28} />
        </div>
       ))}
      </Marquee>
